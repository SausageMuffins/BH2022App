    ...
    <View style={styles.EmployeeSDetails}>
      <View style={styles.Group352}>
        <View style={styles.Component4}>
          <Text style={styles.Txt294}>8:55</Text>
          <Image
            style={styles.Vector}
            source={{
        ...
        <View style={styles.Group524}>
          <Text style={styles.Txt384}>Particulars</Text>
          <View style={styles.Group311}>
            <Text style={styles.Txt502}>Employee Particulars</Text>
            <Image
        ...
        <View style={styles.Group55}>
          <Text style={styles.Txt209}>Delete application</Text>
        </View>
        <Text style={styles.Txt729}>Please enter your employee’s details.</Text>
        <View style={styles.Group62}>
          <Text style={styles.Txt394}>CPF Submission Number (CSN)</Text>
          <View style={styles.Rectangle145} />
          <Text style={styles.Txt466}>Employee’s Company Particulars</Text>
          <Text style={styles.Txt894}>Name</Text>
          <View style={styles.Rectangle134} />
          <Text style={styles.Txt894}>Address</Text>
          <View style={styles.Rectangle135} />
          <Text style={styles.Txt396}>Phone</Text>
          <View style={styles.Rectangle132} />
          <Text style={styles.Txt748}>Employee Particulars</Text>
          <Text style={styles.Txt894}>Occupation/Designation</Text>
          <View style={styles.Rectangle133} />
          <Text style={styles.Txt894}>Date of Employment</Text>
          <View style={styles.Group323}>
            <Text style={styles.Txt236}>DD/MM/YYYY</Text>
          </View>
        </View>
        <View style={styles.Group683}>
          <Text style={styles.Txt770}>Save and Continue</Text>
        </View>
        <View style={styles.Group764}>
          <Text style={styles.Txt770}>Save and Go Back</Text>
        </View>
      </View>
    </View>
  );
